...
<div class="container">
    <div class="card card-selesai">
        <a href='tts1lvl2proses.php'>SELESAI</a>
    </div>
    <div class="card card-selesai">
        <a href='tts1.php'>Back</a>
    </div>
        <div id="countdown" style="font-size: 40vw;"></div>
        <iframe id="crossword" width="750" height="750" style="border:3px solid black; margin:auto; display:block" frameborder="0" src="https://crosswordlabs.com/embed/tts1lvl2"></iframe>
</div>
